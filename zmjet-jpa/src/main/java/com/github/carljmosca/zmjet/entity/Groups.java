...
@NamedQueries({
    ...
    , @NamedQuery(name = "Groups.findByMonitorIds", query = "SELECT g FROM Groups g WHERE g.monitorIds = :monitorIds")})
public class Groups implements Serializable {
    ...
    public Groups(Integer id, String name, String monitorIds) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "com.github.carljmosca.zmjet.entity.Groups[ id=" + id + " ]";
    }
